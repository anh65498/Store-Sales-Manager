...
Getting Started
Prerequisite: Eclipse or any IDE of your choice. As long as user can interact with the console.
Unzip winrar file to get saledat.txt and other .java class in src folder
...
After the program display the information of the store that user seek, it will prompt user if he/she wants to know more information about the Franchise by pressing any key but ‘q’. If user enter ‘q’, the program terminates.
 ...
 Test Run
Refer to testrun.txt for suggestion